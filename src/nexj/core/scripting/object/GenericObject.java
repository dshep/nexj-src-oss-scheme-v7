 ...
 */
public abstract class GenericObject implements ObjectOriented
{
   // constants
   ...
   {
      for (int i = 0, n = m_class.getInitializerCount(); i < n; ++i)
      {
         int nOffset = m_class.getInitializerOffset(i);
         ...
         if (getValue(nOffset, machine) == null)
         {
            ...
            setValue(nOffset, value, machine);
         }
      }
   }
