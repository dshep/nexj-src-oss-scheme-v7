...
public final class URLUtil
{
   ...
   /**
    * Checks is the string represents a URL.
   ...
   public static void addResourceNames(Collection uriCollection, URL rootURL, String sName, boolean bRecurse) throws IOException
   {
      ...
      if (jar != null) // JAR access
      {
         ...
         for (Enumeration resources = jar.entries(); resources.hasMoreElements();)
         {
            String sResource = ((JarEntry)resources.nextElement()).getName();
            int n;
