...
public class J2SELogger extends nexj.core.util.Logger
{
   ...
   /**
    * @see nexj.core.util.Logger#log(int, java.lang.Object)
    */
   ...
   /**
    * @see nexj.core.util.Logger#log(int, java.lang.Object, java.lang.Throwable)
    */
   public void log(int nLevel, Object message, Throwable e)
   {
      Level level = s_levelArray[nLevel];
   ...
   /**
    * @see nexj.core.util.Logger#isLevelEnabled(int)
    */
   public boolean isLevelEnabled(int nLevel)
   {
